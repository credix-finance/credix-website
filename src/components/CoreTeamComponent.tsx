  ...
  return (
    <div className="h-flex-row core-team-component">
      ...
      <div className="h-flex-column core-team-component--advisors">
        ...
        <span className="core-team-component--advisors--name">
          Chike Ukaegbu
        </span>
        <span className="core-team-component--advisors--description">
          Head crypto <br /> emerging markets @ VISA
        </span>
        <span className="core-team-component--advisors--name">
          Joao Bezzerra
        </span>
        <span className="core-team-component--advisors--description">
          Former managing director & <br /> CTO @ ITAU
        </span>
        <span className="core-team-component--advisors--name">
