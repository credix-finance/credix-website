        ...
        show && (
          <div className="h-flex-row h-flex-row--align-center cookie-banner-component">
            <div className="cookie-banner-component--text">We use third party cookies in order to optimize your
                          experience.&nbsp;
            <span className="cookie-banner-component--text cookie-banner-component--text--link h-cursor-pointer">View Cookie Policy</span>
            </div>
            <div className="h-flex-row h-flex-row--justify-center">
