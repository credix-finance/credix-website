      ...
      <div className="h-flex-row footer-component--row">
        ...
        <div className="h-flex-column footer-component--column">
          ...
          <div id="mc_embed_signup" className="footer-component--mailchimp-row">
            <form
              action="https://finance.us20.list-manage.com/subscribe/post?u=6501024066e1753c2aa2d692e&amp;id=e5165ece3c"
              method="post"
            ...
            >
              <div className="footer-component--mailchimp-sub--logo-row">
                {isLightTheme ? (
                  <StaticImage
                    className="footer-component--mailchimp-sub--logo"
                    src={"../assets/shapes/Send_dark.png"}
                    alt={"Send"}
                  />
                ) : (
                  <StaticImage
                    className="footer-component--mailchimp-sub--logo"
                    src={"../assets/shapes/Send.png"}
                    alt={"Send"}
                  />
                )}
              </div>
              ...
              <div
                ...
                className="footer-component--mailchimp-sub"
              >
                <input
                  type="email"
                  name="EMAIL"
                  className="footer-component--email"
                  id="mce-EMAIL"
                ...
                >
                  <input
                    type="text"
                    name="b_6501024066e1753c2aa2d692e_e5165ece3c"
                    tabIndex={-1}
                    value=""
                  />
                </div>
