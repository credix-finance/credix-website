...
export const InvestorsList = () => (
    <>
        ...
        <div className='h-flex-row h-flex-row--space-around h-flex-row--align-center investors-list-component--cta-banner'>
            <div>
                <CTADividerSmall/>
                <span className='h-flex-row investors-list-component--cta-banner--title'>Invest in the future of credit markets</span>
            </div>
