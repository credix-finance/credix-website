    ...
    <div className="h-flex-column home-component-investors">
      ...
      <div className="h-flex-row cta-block">
        <div className="h-flex-column">
          ...
          <span className="cta-block-investors--text">Decentralized finance with stable return, flexibility to withdraw at any moment and invest in senior tranche.</span>
          <PopupButton className="cta-component-investors--button h-margin-top--triple" id="E98Qjiw9">Become an investor</PopupButton>
        </div>
      </div>
    </div>
  )
