...
export const QuoteA55 = () => (
  <>
    <StaticImage className="quotes-component--a55--background-shape-quotation-start" src="../../assets/shapes/quotation-mark-start.png" alt="quotation mark"/>
    <div className="h-flex-column">
      ...
      <StaticImage className="quotes-component--a55--background-shape-quotation-end" src="../../assets/shapes/quotation-mark-end.png" alt="quotation mark"/>
    </div>
  </>
)